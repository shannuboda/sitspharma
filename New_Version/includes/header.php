...
<body style="display:flex;flex-direction: column">
    ...
    <nav>
        ...
        <div class="nav-bar" style="background: #4b257e;">
                ...
                <ul class="nav-links">
                    ...
                    <li>
                        ...
                        <ul class="sub-menu">
                            ...
                            <li><a href="departments.php">Courses</a></li>
        ...
        <div class="mq">
            <ul>
                <li> <a href="https://example.com/article1"
                        target="_blank">Understanding the Basics of Web Development</a></li>
                <li> <a href="https://example.com/article2" target="_blank">A
                        Comprehensive Guide to CSS Grid Layout</a></li>
                <li> <a href="https://example.com/article3" target="_blank">JavaScript
                        ES6 Features You Should Know</a></li>
                <li> <a href="https://example.com/article4" target="_blank">How to
                        Optimize Your Website for SEO</a></li>
                <li> <a href="https://example.com/article5" target="_blank">Top 10
                        JavaScript Libraries for Front-End Development</a></li>
                <li> <a href="https://example.com/article6" target="_blank">The Future
                        of Web Development: Trends to Watch</a></li>
                <li> <a href="https://example.com/article7" target="_blank">An
                        Introduction to Responsive Web Design</a></li>
                <li><a href="https://example.com/article8" target="_blank">How to Use
